...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"request"}[chunkId]||chunkId) + ".bundle.js";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ARTICLES_ADDING_NUMBER; });
/* unused harmony export ARTICLES_DEFAULT_NUMBER */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return NEWS_SOURCES; });
var API_KEY = '46cfaea2895a4945a21de12ace31007c';
var ARTICLES_ADDING_NUMBER = 6;
var ARTICLES_DEFAULT_NUMBER = 6;
var NEWS_SOURCES = [{ name: 'ABC News', id: 'abc-news' }, { name: 'BBC News', id: 'bbc-news' }, { name: 'CNN News', id: 'cnn' }, { name: 'IGN News', id: 'ign' }, { name: 'NBC News', id: 'nbc-news' }, { name: 'News24', id: 'news24' }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_whatwg_fetch__ = __webpack_require__(328);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_config_js__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_components_ArticlesBox_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_components_Source_js__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__js_components_SourceChooser_js__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_main_scss__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_main_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__styles_main_scss__);
...
var sourcesArray = [],
    articlesArray = [],
    sourceChooser = void 0,
    articlesBox = void 0,
    newsSourceStorage = new Map(),
    //will store already downloaded information
showMoreButton = document.querySelector('.showMoreButton'),
    pageOverlay = document.querySelector('#overlay');

__WEBPACK_IMPORTED_MODULE_2__js_config_js__["c" /* NEWS_SOURCES */].forEach(function (source) {
    sourcesArray.push(Object(__WEBPACK_IMPORTED_MODULE_4__js_components_Source_js__["a" /* default */])(source));
});
document.querySelector('.sourceListContainer').innerHTML = Object(__WEBPACK_IMPORTED_MODULE_5__js_components_SourceChooser_js__["a" /* default */])(sourcesArray);

articlesBox = new __WEBPACK_IMPORTED_MODULE_3__js_components_ArticlesBox_js__["a" /* default */](__WEBPACK_IMPORTED_MODULE_2__js_config_js__["b" /* ARTICLES_ADDING_NUMBER */]);

if (false) {
    console.warn('Development mode');
}

document.querySelector('.sourceList').addEventListener('click', function (e) {
    if (e.target.tagName != 'LI') return;

    var selectedSourceId = e.target.getAttribute('data-source-id'),
        selectedSourceIsActive = e.target.getAttribute('data-source-active'),
        resultSource = void 0,
        xhr = void 0,
        articles = void 0;

    if (selectedSourceIsActive === 'false') {
        e.target.setAttribute('data-source-active', 'true');
        ...
        if (resultSource) {
            ...
            __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 334)).then(function (module) {
                var requestSource = module.default;

                requestSource(selectedSourceId).then(function (response) {
        ...
        e.target.setAttribute('data-source-active', 'false');
        e.target.classList.toggle('activeSource');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Article_js__ = __webpack_require__(330);
...
var ArticlesBox = function () {
    function ArticlesBox() {
        var articlesAddingNumber = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3;

        _classCallCheck(this, ArticlesBox);
    ...
    _createClass(ArticlesBox, [{
        key: 'increaseRenderedArticles',
        value: function increaseRenderedArticles() {
        ...
        key: 'addSource',
        value: function addSource(articles) {
            var addedArticles = [];

            if (this.articlesArray.find(function (e) {
                return e.sourceId === articles[0].source.id;
            })) return;
            ...
            articles.forEach(function (elem) {
                addedArticles.push(new __WEBPACK_IMPORTED_MODULE_0__Article_js__["a" /* default */](elem.author, elem.description, elem.publishedAt, elem.source, elem.title, elem.url, elem.urlToImage));
            });
            this.articlesArray = this.articlesArray.concat(addedArticles);

            this.articlesArray.sort(function (art1, art2) {
                return art1.publishDate < art2.publishDate ? 1 : -1;
            });
        }
    }, {
        key: 'removeSource',
        value: function removeSource(sourceId) {
            this.articlesArray = this.articlesArray.filter(function (value) {
        ...
        key: 'fullyShowed',
        value: function fullyShowed() {
            return this._articlesDisplayedNumber === this.articlesArray.length;
        }
    }, {
        key: 'render',
        value: function render() {
            var articlesStringTemplate = '',
                numberToDisplay = this._articlesDisplayedNumber > this.articlesArray.length ? this.articlesArray.length : this._articlesDisplayedNumber;
...
/* harmony default export */ __webpack_exports__["a"] = (ArticlesBox);
...
var Article = function () {
	function Article(author, description, publishDate, sourceObj, title, url, imgUrl) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = SourceChooser;
function SourceChooser(sourceArr) {
    var sourcesStringTemplate = '';
    sourceArr.forEach(function (source) {
        sourcesStringTemplate += source;
    });
